...
var React5, import_react, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, hasOwn, typePropName, labelPropName, Insertion, Emotion;
...
var React6, import_hoist_non_react_statics2, isDevelopment3, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Insertion3, ClassNames, isBrowser2, isTestEnv, globalContext, globalKey;
var init_emotion_react_browser_development_esm = __esm({
  "../node_modules/@emotion/react/dist/emotion-react.browser.development.esm.js"() {
    ...
    Global = withEmotionCache(function(props, cache2) {
      ...
      var serialized = serializeStyles([styles3], void 0, React6.useContext(ThemeContext));
...
var React7, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, isDevelopment4, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
...
var React8, import_prop_types3, import_jsx_runtime2, cache;
...
var React9, import_prop_types4, import_jsx_runtime3;
  ...
  "../node_modules/@mui/system/createTheme/createBreakpoints.js"(exports) {
    ...
    function createBreakpoints2(breakpoints) {
      const {
        ...
        unit = "px",
        step = 5
      } = breakpoints, other = (0, _objectWithoutPropertiesLoose2.default)(breakpoints, _excluded29);
...
var require_breakpoints = __commonJS({
  "../node_modules/@mui/system/breakpoints.js"(exports) {
    ...
    function mergeBreakpointsInOrder2(breakpointsInput, ...styles3) {
      ...
      const mergedOutput = [emptyBreakpoints, ...styles3].reduce((prev2, next2) => (0, _deepmerge.default)(prev2, next2), {});
...
var require_applyStyles = __commonJS({
  "../node_modules/@mui/system/createTheme/applyStyles.js"(exports) {
    ...
    function applyStyles2(key, styles3) {
      const theme = this;
  ...
  "../node_modules/@mui/system/createTheme/createTheme.js"(exports) {
    ...
    function createTheme3(options = {}, ...args) {
      const {
        ...
        spacing: spacingInput,
        shape: shapeInput = {}
      } = options, other = (0, _objectWithoutPropertiesLoose2.default)(options, _excluded29);
...
var require_extendSxProp = __commonJS({
  "../node_modules/@mui/system/styleFunctionSx/extendSxProp.js"(exports) {
    ...
    function extendSxProp2(props) {
      const {
        sx: inSx
      } = props, other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded29);
      const {
        systemProps,
        otherProps
      } = splitProps2(other);
...
var require_createStyled = __commonJS({
  "../node_modules/@mui/system/createStyled.js"(exports) {
    ...
    function processStyleArg2(callableStyle, _ref) {
      let {
        ownerState
      } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded29);
      ...
      if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
        const {
          variants = []
        } = resolvedStylesArg, otherStyles = (0, _objectWithoutPropertiesLoose2.default)(resolvedStylesArg, _excluded210);
    ...
    function createStyled5(input = {}) {
      ...
      return (tag, inputOptions = {}) => {
        (0, _styledEngine.internal_processStyles)(tag, (styles3) => styles3.filter((style4) => !(style4 != null && style4.__mui_systemSx)));
        const {
          name: componentName,
          slot: componentSlot,
...
var PropsContext = React10.createContext(void 0);
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime9.jsx)(GlobalStyles, {
    styles: globalStyles
  });
}
...
function createBox(options = {}) {
  ...
  const Box2 = React26.forwardRef(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded12);
    return (0, import_jsx_runtime10.jsx)(BoxRoot, _extends({
      as: component,
      ref,
...
function isMuiElement(element, muiNames) {
  ...
  return React28.isValidElement(element) && muiNames.indexOf(
...
function createContainer(options = {}) {
  ...
  const Container2 = React41.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime16.jsx)(ContainerRoot, _extends({
        as: component,
        ownerState,
        className: clsx_default(classes.root, className),
        ref
...
function createGrid(options = {}) {
  ...
  const Grid2 = React42.forwardRef(function Grid3(inProps, ref) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime17.jsx)(GridOverflowContext.Provider, {
...
function createStack(options = {}) {
  ...
  const Stack2 = React43.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime18.jsx)(StackRoot, _extends({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(React46.Fragment, {
...
var Portal = React47.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React47.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime22.jsx)(React47.Fragment, {
      children: children2
    });
  }
  return (0, import_jsx_runtime22.jsx)(React47.Fragment, {
...
var Fade = React48.forwardRef(function Fade2(props, ref) {
  const theme = useTheme5();
...
var Backdrop = React49.forwardRef(function Backdrop2(inProps, ref) {
...
var Paper = React52.forwardRef(function Paper2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiPaper"
  });
...
true ? Paper.propTypes = {
   ...
   * @default false
   */
  square: import_prop_types36.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'elevation'
   */
  variant: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf(["elevation", "outlined"]), import_prop_types36.default.string])
} : void 0;
